...
function MudarTema(){
    ...
    else{Cores('#0A0714', '#4A4D54','linear-gradient(to right, #C129EB, #9733DD)', '#313338', '#313338', '#F2F3F5', '#9F9F9F');
...
async function PLAY(){
    ...
    numeroQuestao = ImprimeTexto(`Pergunta ${questoes+1}/10`, 'texto', divPerguntas, CorTextoPrincipal);
    numeroQuestao.style.fontSize = '15px';

    PerguntaText = ImprimeTexto(`${Pergunta}`, 'texto', divPerguntas, CorTextoPrincipal);
...
function AbreMenu(){
    naoclicavel.style.width='100vw'; naoclicavel.style.height='100%';
